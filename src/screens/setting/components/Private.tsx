...
const Private = ({ data }: Props) => {
  ...
  return (
    <Section>
      <TitleSecction title={'Permission'} />
      {data && (
        <ItemChoose
      ...
      <ItemChoose iconLeft={STITCH_ICON} name={'Permission 1'} />
      <ItemChoose iconLeft={MESSAGE_OUTLINE_ICON} name={'Permission 1'} />
      <ItemChoose iconLeft={FIBER_SMART_RECORD_ICON} name={'Permission 1'} />
    </Section>
  );
};
